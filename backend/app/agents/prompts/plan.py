...
- Follow skill.directives exactly (e.g. character-first, scene-first, short punchy comedy).
- Honor pipeline_hints.prioritize / tone / shot_bias / fixed_shot_count when choosing detail level and shot count.
